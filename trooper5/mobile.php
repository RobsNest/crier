...
function updateGameArea() {
    ...
    for (i = 0; i < myObstacles.length; i += 1) {
        if (myGamePiece.crashWith(myObstacles[i])) {
			...
			bkSound.play();
			myGameArea.stop();
			document.getElementById("btn").innerHTML = "|=|=| <b>GAME OVER</b> Click the Trooper 5 link below to play again! |=|=|";
            return;
        } 
    }
    myGameArea.clear();
...
<br />
<center><a href="mobile.php" class="title">Trooper 5</a></center>
