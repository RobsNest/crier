...
if ( $detect->isMobile() ) {
	header('Location: puzzle/cumberland.html');
    exit;
}
...
<head>
	<title>Cumberland Slider, A Javascript Game - The Cumberland Crier - <?php echo $today?></title>
  	
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />	
	<meta name=”description” content=”A Javascript Game with a Cumberland Maryland flavor.” />
...
<center><a href="puzzle/cumberland.html" class="tandt" target="display">Cumberland, Md</a></center>

<center>
<iframe name="display" id="display" src="puzzle/cumberland.html" width="410" height="310" 
