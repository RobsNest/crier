...
<head>
	<title>Poll - Gun Control Legislation - The Cumberland Crier - <?php echo $today?></title>
...
<div class="pollquestion">
&nbsp;&nbsp;&nbsp;&nbsp;
Do you beieive Marijuana should be legalized for recreational 
purposes?<br />
