...
<!-- Begin
	...
	day = new Date();
	id = day.getTime();
	eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=0,width=750,height=530');");
	}
// End -->
</script>
...
<!-- Begin
	...
	day = new Date();
	id = day.getTime();
	eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=0,width=675,height=530');");
	}
// End -->
</script>
</head>
...
<center>
<iframe  src="scannerpre.php" width="315" height="325" 
...
<center>
<a href="javascript:ShowMap('scanmap.php')" class="pub"><b>Regional Map</b></a>
&nbsp; - &nbsp; 
<a href="javascript:ShowCompanies('FireEMSCompanies.pdf')" class="pub"><b>Company List</b></a>
</center>
</td>
</tr></table>
