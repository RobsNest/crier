...
body
{
background-image:url('cumberland.jpg');
...
function startGame() {
	...
	bkSound = new sound("trooper5.mp3");
...
function updateGameArea() {
    ...
    for (i = 0; i < myObstacles.length; i += 1) {
        if (myGamePiece.crashWith(myObstacles[i])) {
			...
			bkSound.play();
			myGameArea.stop();
			document.getElementById("btn").innerHTML = "|=|=| <b>Game Over:</b> Click the Trooper 5 Link above to play again! |=|=|";
			document.getElementById("dshlite").color = "#FF0000";
            return;
        } 
    }
    myGameArea.clear();
...
function accelerate(n) {
    if (!myGameArea.interval) {
		...
		document.getElementById("dshlite").color = "#00C000";
	}
...
<center>
<hr id="dshlite" width="50" color="#C0C0FF" size="10" />
<button onTouchStart="accelerate(-0.2)" onTouchEnd="accelerate(0.05)"><p id="btn"><b>|=|=| START |=|=|</b></p></button>
</center>

<br />
<center><a href="t5mobile.php" class="title">Restart Trooper 5</a></center>
