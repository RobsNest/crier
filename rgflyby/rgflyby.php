...
function updateGameArea() {
    ...
    for (i = 0; i < myObstacles.length; i += 1) {
        if (myGamePiece.crashWith(myObstacles[i])) {
			...
			bkSound.play();
			myGameArea.stop();
			document.getElementById("btn").innerHTML = "|=|=| <b>Game Over:</b> Click the Rocky Gap Fly By Link above to play again! |=|=|";
            return;
        } 
    }
    myGameArea.clear();
...
<center>
<button onmousedown="accelerate(-0.2)" onmouseup="accelerate(0.05)"><p id="btn"><b>|=|=| START |=|=|</b></p></button>
</center>
