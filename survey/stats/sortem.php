...
<td align="center"><a href="participants.php" class="tablink">E-Mail</a></td>
...
<td align="center"><a href="sorted.php" class="tablink">Entry Date</a></td>
</tr>

<?php

$bgcolor = "#C0FFFF";
$sql = "SELECT id, email, ip, ipcity, entdate FROM participant ORDER BY email ASC";
$result = $db->query($sql);
...
if ($result->num_rows > 0) {
	while($row = $result->fetch_assoc()) {
		...
		echo "<td align=\"center\"><a href=\"mailto:" . $row["email"] . "\" class=\"emlink\">" . $row["email"] . "</a></td>";
