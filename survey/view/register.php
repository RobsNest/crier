...
$warning = "A Valid E-Mail Address Is The ONLY Required Field.";
$focus = "email";
$email = "";
$name = "";
$street = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if($botChk == "") {
		...
		$sql = "INSERT INTO participant (email, name, street, ip, ipcity,  entdate)
				VALUES ('$email', '$name', '$street', '$ip', '$ipcity', '$entDate')";
...
<head>
	<title>A Survey For Cumberland Residence.</title>
