...
$endDate = date('l F jS Y H:i:s', strtotime('3 days'));
...
<input type="hidden" name="action" value="createad" />
	...
	<input type="text" class="forminput" id="email" name="email" size="42" maxlength="100" value="<?php echo $email?>" />
	</td></tr>
	<tr align="center">
	<td align="right">
	...
	<input type="text" id="phone" name="phone" size="21" maxlength="22" />
        <textarea id="plaintext" name="plaintext" class="forminput" rows="3" cols="44" maxlength="132" onKeyDown="textCounter('plaintext', 'plaintextcount',132);" onKeyUp="textCounter('plaintext', 'plaintextcount',132);" ><?php echo $adtext?></textarea><br/>
