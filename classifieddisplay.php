...
<div class="article">
You get 132 characters and a full day of display completely free of charge.
</div>
<br />
...
<a href="newad.php"><img src="images/ads/ColorAndGraphics195x113.png" width="195" height="113" /></a>
<br /><br />
...
<div class="article">
Readership is increasing everyday. Take advantage of our <b>Free</b> Classified Ads.
</div>
<br />
...
$sql = "SELECT id, expDate, viewable, email, category, ad FROM classifieds WHERE category = 'In Search Of'";
$result = $db->query($sql);
echo "<div class=\"article\"><center><b>In Search Of</b></center><hr>";
if ($result->num_rows > 0) {
    // output data of each row
	while($row = $result->fetch_assoc()) {
		if($row["expDate"] < $now) {
	...
	echo "Be the first to post a free Classified Ad in In Search Of";
}
echo "</div><br />";
?>
